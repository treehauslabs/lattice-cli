...
struct InitCommand: ParsableCommand {
    ...
    func run() throws {
        ...
        - [Lattice](https://github.com/treehauslabs/lattice) — Blockchain core
        - [Acorn](https://github.com/treehauslabs/Acorn) — Content-addressed storage
        - [Ivy](https://github.com/treehauslabs/Ivy) — P2P networking
        """
